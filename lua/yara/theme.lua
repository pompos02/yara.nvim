...
local function set_highlights()
    ...
    local default_highlights = {
        ...
        PmenuExtraSel = { fg = palette.subtle, bg = palette.highlight_high },
        PmenuKind = { fg = palette.lavender, bg = palette.bg },
        PmenuKindSel = { fg = palette.subtle, bg = palette.highlight_high },
        PmenuMatch = { fg = palette.blue },
        PmenuMatchSel = { fg = palette.blue, bg = palette.highlight_high },
        PmenuSbar = { bg = palette.bg },
        PmenuSel = { fg = palette.text, bg = palette.highlight_high },
        ...
        StatusLineNC = { fg = palette.subtle, bg = palette.base, blend = 60 },
        StatusLineTerm = { fg = palette.subtle, bg = palette.blue },
        StatusLineTermNC = { fg = palette.subtle, bg = palette.blue, blend = 60 },
        ...
        BlinkCmpLabelMatch = { fg = palette.blue, bg = "NONE", bold = styles.bold },
        BlinkCmpLabelMatchSelected = { fg = palette.blue, bg = "NONE", bold = styles.bold },
